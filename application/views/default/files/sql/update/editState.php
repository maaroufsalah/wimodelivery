...
if (empty($name) ||empty($color) ||empty($background) || !$id) {
echo "
...
$stmt->bindParam(':state_name', $name, PDO::PARAM_STR);
$stmt->bindParam(':state_color', $color, PDO::PARAM_STR);
$stmt->bindParam(':state_background', $background, PDO::PARAM_STR);
