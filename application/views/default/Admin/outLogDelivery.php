...
if ((hasUserPermission($con, $loginId, 23 ,'admin')) || ($loginRank == "delivery")){
...
$.ajax({
url: 'getLogs?do=outlog_delivery', // سكربت PHP الذي سيعالج الطلب
method: 'POST',
data: { 
page: page,
search: search,
...
$result = "data_result"; 
$action = "newLog?do=outlog_delivery"; 
$method = "post"; 
...
AND
 or_state_delivery NOT IN (1,0,4,68,66,51,65) AND or_delivery_user = '$userId'
ORDER BY or_id DESC ");
$stmt->execute();
