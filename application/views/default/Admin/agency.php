...
<a href='?do=new' class="btn btn-primary my-3 btn-sm">Ajouter Agence</a>
</div>
  ...
  <div class="my-3">
    ...
    <select name="city[]" class="js-select w-100 city" multiple>
      <?php foreach ($city as $rowc): ?>
        <option value='<?= $rowc['city_id'] ?>'><?= $rowc['city_name'] ?></option>
      <?php endforeach; ?>
    </select>
