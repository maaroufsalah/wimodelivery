...
if ((hasUserPermission($con, $loginId, 32 ,'admin'))||($loginRank == "delivery")){
...
<div class="col-sm-12 text-center">
<button class="btn my-3 btn-danger">Vider Scanner</button>
</div>
...
$.ajax({
url: 'check_code',  // Assure-toi que ce fichier retourne du HTML
type: 'POST',
data: { code: code },
